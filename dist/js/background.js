...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assets_parsers_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/assets/parsers/html.js */ \"./src/assets/parsers/html.js\");\n/* harmony import */ var _assets_parsers_deepHtml_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/assets/parsers/deepHtml.js */ \"./src/assets/parsers/deepHtml.js\");\n/* harmony import */ var _assets_parsers_json_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/assets/parsers/json.js */ \"./src/assets/parsers/json.js\");\n/* harmony import */ var _assets_parsers_custom_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/assets/parsers/custom.js */ \"./src/assets/parsers/custom.js\");\n/* harmony import */ var _assets_parsers_default_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/assets/parsers/default.js */ \"./src/assets/parsers/default.js\");\n\n\n\n\n\n\n\nconst parsers = {\n  html: _assets_parsers_html_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n  json: _assets_parsers_json_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n  custom: _assets_parsers_custom_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n  stub: _assets_parsers_default_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"],\n  deepHtml: _assets_parsers_deepHtml_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (parsers);\n\n//# sourceURL=webpack:///./src/assets/parsers.js?");
...
/***/ "./src/assets/parsers/deepHtml.js":
/*!****************************************!*\
  !*** ./src/assets/parsers/deepHtml.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Basket_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/models/Basket.js */ \"./src/models/Basket.js\");\n/* harmony import */ var _models_Entry_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/models/Entry.js */ \"./src/models/Entry.js\");\n/* harmony import */ var _modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/modules/applyMods.js */ \"./src/modules/applyMods.js\");\n\n\n\n\n\n\nasync function getDeep(url, selector, container) {\n  let result = 0;\n  await fetch(url).then(response => {\n    return response.text();\n  }).then(html => {\n    const parser = new DOMParser();\n    const doc = parser.parseFromString(html, 'text/html');\n    return doc;\n  }).then(doc => {\n    result = doc.querySelector(selector)[container];\n  });\n  return result;\n}\n\nasync function parseDeepHtml(merchant) {\n  let totalSum = 0;\n  const entries = [];\n  await fetch(merchant.rules.url).then(response => {\n    return response.text();\n  }).then(html => {\n    const parser = new DOMParser();\n    const doc = parser.parseFromString(html, 'text/html');\n    return doc;\n  }).then(doc => {\n    const list = doc.querySelector(merchant.rules.list.value);\n    totalSum = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(doc.querySelector(merchant.rules.totalSum.value).innerText, merchant.rules.totalSum.mods);\n    return list;\n  }).then(list => {\n    const goods = list.querySelectorAll(merchant.rules.self.value);\n    return goods;\n  }).then(async goods => {\n    for (let i = 0; i < goods.length; i++) {\n      const deepUrl = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(goods[i].querySelector(merchant.rules.deepUrl.value).href, merchant.rules.deepUrl.mods, merchant);\n      const sku = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(goods[i].querySelector(merchant.rules.sku.value).innerText, merchant.rules.sku.mods);\n      const name = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(goods[i].querySelector(merchant.rules.name.value).innerText, merchant.rules.name.mods);\n      const price = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(await getDeep(deepUrl, merchant.rules.price.deep.value, merchant.rules.price.deep.container), merchant.rules.price.mods);\n      const totalPrice = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(goods[i].querySelector(merchant.rules.totalPrice.value).innerText, merchant.rules.totalPrice.mods);\n      const quantity = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(goods[i].querySelector(merchant.rules.quantity.value).innerText, merchant.rules.quantity.mods);\n      const photo = Object(_modules_applyMods_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(goods[i].querySelector(merchant.rules.photo.value).src, merchant.rules.photo.mods);\n      entries.push(new _models_Entry_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](sku, name, price, totalPrice, quantity, photo));\n    }\n  }).catch(error => {\n    // eslint-disable-next-line\n    console.error(error);\n  });\n  return new _models_Basket_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](entries, totalSum);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (parseDeepHtml);\n\n//# sourceURL=webpack:///./src/assets/parsers/deepHtml.js?");
